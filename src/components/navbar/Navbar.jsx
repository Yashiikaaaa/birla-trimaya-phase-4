...
import logo from "../../assets/navbar/image.png"; // Importing Prestige Logo
      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-0 flex flex-wrap items-center justify-between py-[4px] z-40">
        ...
        <div className="hidden lg:flex items-center">
          <a
            ...
            className="flex items-center bg-[#a0793b] text-white px-3 py-2 rounded-lg shadow-lg hover:bg-opacity-90 transition"
          >
